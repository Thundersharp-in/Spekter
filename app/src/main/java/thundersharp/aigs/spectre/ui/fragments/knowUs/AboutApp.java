...
public class AboutApp extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        appicon = root.findViewById(R.id.toolbar);
        ...
        perholder.setText(getPermissionsByPackageName("thundersharp.aigs.spectre"));

        try {
            packageInfo = packageManager.getPackageInfo("thundersharp.aigs.spectre", 0);
