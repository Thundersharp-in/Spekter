...
public class LiveTraining extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.fragment_live_training, container, false);

        rv_CS = root.findViewById(R.id.rv_LT);
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()){
                            ...
                            adapter = new ServiceItemAdapter(modelList,getActivity(),CONSTANTS.DATABASE_COURSES_LIVE);
                            shimmer.stopShimmer();
